...
module.exports = {
  ...
  HEISENBUG_CONFIG, CODE_REVIEW_CONFIG, RUBBER_DUCK_CONFIG, MERGE_CONFLICT_CONFIG, DEPENDENCY_BUG_CONFIG, HOTFIX_HAMMER_CONFIG,
};
