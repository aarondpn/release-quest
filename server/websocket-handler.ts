...
export function setupWebSocketConnection(
  ...
  ws.on('message', async (raw: RawData) => {
    ...
    const SPECTATOR_BLOCKED = new Set(['click-bug', 'click-boss', 'click-duck', 'click-hammer', 'start-game', 'shop-buy', 'shop-ready', 'select-role', 'chat-message', 'create-lobby', 'join-lobby', 'join-lobby-by-code', 'map-vote', 'event-vote']);
